...
- not a lot of literature about it with focus on missing data
- not a lot of visualization tools for data sets including missing values R package VIM supports the visualization (also with a GUI).
...
Random within groups imputation, grouping variables will be dropped sequentially if no all values are missing in a group.
```{r,echo=TRUE,eval=FALSE}
matchImpute(data,
